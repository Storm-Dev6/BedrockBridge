...
public final class ConnectedPing extends AbstractBedrockHandshakePacket {
    ...
    @Override public void encode(PacketWriter writer) { writer.writeLong(pingTime); }
    @Override public void decode(PacketReader reader) { pingTime = reader.readLong(); }
}
