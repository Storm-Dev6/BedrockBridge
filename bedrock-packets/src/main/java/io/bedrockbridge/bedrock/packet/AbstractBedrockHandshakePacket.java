...
public abstract class AbstractBedrockHandshakePacket implements Packet {
    ...
    @Override public final int packetId() { return packetId; }
    @Override public final ProtocolVersion protocolVersion() { return BedrockProtocol.HANDSHAKE_VERSION; }
    @Override public final ProtocolState state() { return ProtocolState.HANDSHAKE; }
    @Override public final PacketDirection direction() { return direction; }
}
