...
public final class ConnectedPong extends AbstractBedrockHandshakePacket {
    ...
    public long pingTime() { return pingTime; }
    public long pongTime() { return pongTime; }
    @Override public void encode(PacketWriter writer) { writer.writeLong(pingTime); writer.writeLong(pongTime); }
    @Override public void decode(PacketReader reader) { pingTime = reader.readLong(); pongTime = reader.readLong(); }
}
